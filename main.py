...
from cpmnuker import OfficialGoodShit
...
def banner(console):
    ...
    brand_name = figlet_format('EmRitzCpm2', font='drpepper')
    colors = [
    ...
    console.print("[bold green]♕ EmritzCpm2[/bold green]: Car Parking Multiplayer 2 Hacking Tool.")
        ...
        while True:
            ...
            if service == 0: # Exit
                ...
                if status == 0:
                    console.print("[bold green]SUCCESSFUL.[/bold green]")
                    console.print("==================================")
                    console.print(f"[bold red]! INFO[/bold red]: In order to tweak this account with EmritzCpm2")
