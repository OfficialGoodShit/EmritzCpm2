...
class OfficialGoodShit:
    ...
    def maximize_drag_wins(self) -> bool:
        ...
        params = { "key": self.access_key }
        try:
            response = requests.post(f"{__ENDPOINT_URL__}/maximize_drag_wins", params=params, data=payload)
            response.encoding = 'utf-8'
            response_decoded = response.json()
        except UnicodeEncodeError:
            print("Encoding error with UTF-8. Please check your input.")
    ...
    def complete_missions(self) -> bool:
        ...
        params = { "key": self.access_key }
        try:
            response = requests.post(f"{__ENDPOINT_URL__}/complete_missions", params=params, data=payload)
            response.encoding = 'utf-8'
            response_decoded = response.json()
        except UnicodeEncodeError:
            print("Encoding error with UTF-8. Please check your input.")
    ...
    def unlock_apartments(self) -> bool:
        ...
        params = { "key": self.access_key }
        try:
            response = requests.post(f"{__ENDPOINT_URL__}/unlock_apartments", params=params, data=payload)
            response.encoding = 'utf-8'
            response_decoded = response.json()
        except UnicodeEncodeError:
            print("Encoding error with UTF-8. Please check your input.")
    ...
    def unlock_slots(self) -> bool:
        ...
        params = { "key": self.access_key }
        try:
            response = requests.post(f"{__ENDPOINT_URL__}/unlock_slots", params=params, data=payload)
            response.encoding = 'utf-8'
            response_decoded = response.json()
        except UnicodeEncodeError:
            print("Encoding error with UTF-8. Please check your input.")
    ...
    def unlock_brakes(self) -> bool:
        ...
        params = { "key": self.access_key }
        try:
            response = requests.post(f"{__ENDPOINT_URL__}/unlock_brakes", params=params, data=payload)
            response.encoding = 'utf-8'
            response_decoded = response.json()
        except UnicodeEncodeError:
            print("Encoding error with UTF-8. Please check your input.")
    ...
    def unlock_clothes(self) -> bool:
        ...
        params = { "key": self.access_key }
        try:
            response = requests.post(f"{__ENDPOINT_URL__}/unlock_equipments", params=params, data=payload)
            response.encoding = 'utf-8'
            response_decoded = response.json()
        except UnicodeEncodeError:
            print("Encoding error with UTF-8. Please check your input.")
    ...
    def unlock_cars(self) -> bool:
        ...
        params = { "key": self.access_key }
        try:
            response = requests.post(f"{__ENDPOINT_URL__}/unlock_cars", params=params, data=payload)
            response.encoding = 'utf-8'
            response_decoded = response.json()
        except UnicodeEncodeError:
            print("Encoding error with UTF-8. Please check your input.")
